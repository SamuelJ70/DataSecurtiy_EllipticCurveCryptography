...
public partial class Share_File : System.Web.UI.Page
{
    ...
    public void Send_Mail(string email_id,  string key_value)
    {
        try
        {
            ...
            SmtpServer.Credentials = new System.Net.NetworkCredential("j6913207@gmail.com", "samuel0404");
            SmtpServer.Port = 587;
            SmtpServer.EnableSsl = true;
            SmtpServer.Host = "smtp.gmail.com";
            mail = new MailMessage();
            mail.From = new MailAddress("j6913207@gmail.com");

            mail.To.Add(email_id);
            mail.Subject = "Customer  Details";
            mail.Body = "This is to inform you that your organization has shared a file with You. Access Details as Follows. Secrect Key is '" + key_value
                + "' ";
